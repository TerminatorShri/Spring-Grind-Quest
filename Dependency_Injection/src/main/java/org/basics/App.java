...
public class App {
    public static void main(String[] args) {
        ...
        Temp temp1 = (Temp) context.getBean("temp1");
        System.out.println(temp1);
        System.out.println(temp1.getTempValues());

        Temp temp2 = (Temp) context.getBean("temp2");
        System.out.println(temp2);
        System.out.println(temp2.getTempValues());

        AbstractApplicationContext abstractContext = context;
        Temp destroyTemp = (Temp) abstractContext.getBean("temp1");
